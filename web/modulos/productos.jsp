                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-lg nuevoCodigo" placeholder="Ingresar código" required disabled="true">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" maxlength="100" class="form-control input-lg nuevaDescripcion" placeholder="Ingresar descripción" autocomplete="off" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control input-lg nuevaCantidad" min="0" placeholder="Cantidad inicial" required>
                            </div>
